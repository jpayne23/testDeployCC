...
func (t *SimpleChaincode) get_ecert(stub *shim.ChaincodeStub, name string) ([]byte, error) {
	...
	response, err := http.Get("http://"+string(peer_address)+"/registrar/"+name+"/ecert") // Calls out to the HyperLedger REST API to get the ecert of the user with that name
															...
															if err != nil { return nil, errors.New("Unable to connect to peer address") }
...
func (t *SimpleChaincode) get_owner(stub *shim.ChaincodeStub, v Vehicle) (string, error) {
...
func (t *SimpleChaincode) get_user_data(stub *shim.ChaincodeStub, name string) ([]byte, int64, error){
	...
	ecert, err := t.get_ecert(stub, name)	;					if err != nil { return nil, -1, err }
...
//=================================================================================================================================
func (t *SimpleChaincode) create_vehicle(stub *shim.ChaincodeStub, caller_name string, caller_ecert []byte, caller_role int64, v5cID string) ([]byte, error) {								
...
//=================================================================================================================================
func (t *SimpleChaincode) authority_to_manufacturer(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, recipient_name string, recipient_ecert []byte, recipient_role int64) ([]byte, error) {
...
//=================================================================================================================================
func (t *SimpleChaincode) manufacturer_to_private(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, recipient_name string, recipient_ecert []byte, recipient_role int64) ([]byte, error) {
...
//	 private_to_private
//=================================================================================================================================
func (t *SimpleChaincode) private_to_private(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, recipient_name string, recipient_ecert []byte, recipient_role int64) ([]byte, error) {
...
//=================================================================================================================================
func (t *SimpleChaincode) private_to_lease_company(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, recipient_name string, recipient_ecert []byte, recipient_role int64) ([]byte, error) {
...
//=================================================================================================================================
func (t *SimpleChaincode) lease_company_to_private(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, recipient_name string, recipient_ecert []byte, recipient_role int64) ([]byte, error) {
...
//=================================================================================================================================
func (t *SimpleChaincode) private_to_scrap_merchant(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, recipient_name string, recipient_ecert []byte, recipient_role int64) ([]byte, error) {
...
//	 update_vin
//=================================================================================================================================
func (t *SimpleChaincode) update_vin(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, new_value string) ([]byte, error) {
...
//	 update_registration
//=================================================================================================================================
func (t *SimpleChaincode) update_registration(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, new_value string) ([]byte, error) {
...
//	 update_colour
//=================================================================================================================================
func (t *SimpleChaincode) update_colour(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, new_value string) ([]byte, error) {
...
//	 update_make
//=================================================================================================================================
func (t *SimpleChaincode) update_make(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, new_value string) ([]byte, error) {
...
//	 update_model
//=================================================================================================================================
func (t *SimpleChaincode) update_model(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64, new_value string) ([]byte, error) {
...
//	 scrap_vehicle
//=================================================================================================================================
func (t *SimpleChaincode) scrap_vehicle(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_ecert []byte, caller_role int64) ([]byte, error) {
...
//	 get_all
//=================================================================================================================================
func (t *SimpleChaincode) get_all(stub *shim.ChaincodeStub, v Vehicle, current_owner string, caller_name string, caller_role int64) ([]byte, error) {
