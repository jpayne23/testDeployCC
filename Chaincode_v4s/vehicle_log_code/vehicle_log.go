...
func (t *Chaincode) get_ecert(stub *shim.ChaincodeStub, name string) ([]byte, error) {
	...
	response, err := http.Get("https://530d3e34-6757-4169-83d0-0d134881b7da_vp1-api.blockchain.ibm.com:443/registrar/"+name+"/ecert") // Calls out to the HyperLedger REST API to get the ecert of the user with that name
